...
* **Ph.D. in Embedded Electronics**, Badji Mokhtar University, Annaba, Algeria, 2019–2024
  * Thesis: Real-time implementation of algorithms dedicated to the control of a multi-axis system
* **M.S. in Automation and Industrial Computer Science**, Badji Mokhtar University, 2017–2019
  * Ranked among the 20 best master's projects in Algeria by the Ministry of Higher Education (2018/2019)
* **B.S. in Automation**, Badji Mokhtar University, 2014–2017

Work experience
======
* **Since January 2026: Postdoctoral Researcher**
  * École nationale supérieure des mines de Saint-Étienne, France
  * Design and development of a textile-integrated NFC-based wireless charging system
  * Focus: Electronic Systems and Energy Harvesting

* **June 2024 – December 2025: Postdoctoral Researcher**
  * Télécom Paris — Energy4Climate (E4C) project
  * Full hardware design of autonomous weather monitoring stations (PCB from scratch)
  * Solar energy harvesting, battery SoC estimation, and energy management
  * Low-power LoRa communication and STM32 embedded software (Zephyr RTOS)

* **November 2023 – May 2024: Teacher & Researcher**
  * Numidia Institute of Technology, Algeria
  * Research on autonomous robotic date fruit harvesting
  * Teaching: Computer Architecture (L2)

* **May 2023 – November 2023: Method Manager**
  * NECHMA Group, Algeria
  * Developed monitoring dashboards and analysis tools
  * Supervised and trained production chain teams

* **June 2022 – May 2023: Method Engineer**
  * NECHMA Group, Algeria
  * Preventive maintenance planning, production scheduling
  * Coordination across mechanical, automation, and electrical systems

* **November 2020 – June 2022: Part-time Lecturer**
  * Badji Mokhtar University, Algeria
  * Courses: Microcontroller Programming (M1), Industrial Robotics (M1), Non-linear Systems Control (L3), MATLAB (L1)

* **September 2019 – November 2019: Trainer & Automation Engineer**
  * Azm School, Algeria
  * SIEMENS Simatic / TIA Portal training, CNC manufacturing, electronic board maintenance

Skills
======
* **Embedded Systems**
  * STM32 (HAL, Zephyr RTOS, STM32Cube.AI)
  * Raspberry Pi 5, Orange Pi 5 Plus (RKNN NPU)
  * Nordic nRF series, LoRaWAN (TTN integration)
  * NFC (RFAL library, NFC06A1, NFC08A1), INA236 power monitoring

* **Hardware Design**
  * KiCad, Eagle, Proteus
  * Custom PCB design: solar harvesting, battery management, RF front-ends
  * NFC antenna design (13.56 MHz)

* **Machine Learning & Signal Processing**
  * PyTorch — deep learning pipelines (image denoising, classification, AE monitoring)
  * Tensor decomposition: HOSVD, Tucker, CP, Tensor Train
  * Edge inference: TFLite Micro, STM32Cube.AI, RKNN, FP8/INT4 quantization
  * Acoustic emission signal processing and structural health monitoring

* **Programming & Tools**
  * C, C++, Python
  * MATLAB, Simulink
  * Step7, TIA Portal, WinCC
  * SolidWorks

* **Wireless Communication**
  * LoRa / LoRaWAN, NFC, RF systems
  * FOTA with MCUboot on STM32WL
...
======
* Reviewer — *Neural Computing and Applications* journal
* Reviewer — 7th International Conference on Computer Science and Application Engineering (CSAE 2023), Wuhan, China
